 ...
 */
export default class AddBox extends Module<AddBoxNodes> {
  /**
  ...
  public get CSS(): { [name: string]: string } {
    return {
      ...
      // dndButtonHidden: 'ce-toolbar__dnd--hidden',
      //
      // // Actions Zone
  ...
  private make(): void {
    ...
    $.append($.find(document,'.codex-editor__add'), this.nodes.content);
